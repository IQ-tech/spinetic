...
}`,...(xe=(Se=O.parameters)==null?void 0:Se.docs)==null?void 0:xe.source}}};var we,Te,be;j.parameters={...j.parameters,docs:{...(we=j.parameters)==null?void 0:we.docs,source:{originalSource:`(args: TypesConfigOptional | any) => {
  const childrens = generateItems(args.children);
  const change = args.change;
  delete args.children;
  delete args.change;
...
}`,...(be=(Te=j.parameters)==null?void 0:Te.docs)==null?void 0:be.source}}};const st=["Default","AutoWidth","AutoRotate"];export{j as AutoRotate,O as AutoWidth,K as Default,st as __namedExportsOrder,nt as default};
