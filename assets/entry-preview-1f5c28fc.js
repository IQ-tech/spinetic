import { R as o, r as i } from "./index-76fb7be0.js";
import { u as p, r as d } from "./react-18-988a5df2.js";
import "./commonjsHelpers-de833af9.js";
import "./index-d3ea75b5.js";
const { global: u } = __STORYBOOK_MODULE_GLOBAL__;
var { FRAMEWORK_OPTIONS: s } = u,
  _ = (r, t) => {
...
async function C(
  ...
  let m = o.createElement(
      E,
      { showMain: n, showException: e },
      o.createElement(t, { ...r })
    ),
    h = c ? o.createElement(c, null, m) : m;
  return l && p(a), await d(h, a), () => p(a);
}
var D = { renderer: "react" };
export { D as parameters, _ as render, C as renderToCanvas };
