...
_________________________________________________________________________________________________
`},defaultValue:{summary:_.hideArrows}}},progressIndicator:{description:'<span id="dots">Determines the type of progress indicator used in the slider</span>',control:"string",table:{type:{summary:"string"},defaultValue:{summary:_.progressIndicator}}},dots:{description:'<span id="dots">Determines whether to display navigation dots</span>',control:"boolean",table:{type:{summary:"boolean"},defaultValue:{summary:_.dots}}},dotsStyle:{description:'<span id="dotsStyle">Defines the styles for the dots</span>',control:{},table:{type:{summary:"object",detail:`
...
_________________________________________________________________________________________________`},defaultValue:{summary:"See default",detail:`
{
    ...
    dot: {},
    dotActive: {},
}`}}},itemNumberInDot:{description:'<span id="itemNumberInDot">Specifies whether the item number should be displayed in the dot</span>',control:"boolean",table:{type:{summary:"boolean"},defaultValue:{summary:_.itemNumberInDot}}},maxDots:{description:'<span id="maxDots">Sets the maximum number of 5 dots to be shown</span>',control:"boolean",table:{type:{summary:"boolean"},defaultValue:{summary:_.maxDots}}},autoRotate:{description:'<span id="autoRotate">Enables automatic rotation of items</span>',control:"boolean",table:{type:{summary:"boolean"},defaultValue:{summary:_.autoRotate}}},msPerAutoRotate:{description:'<span id="msPerAutoRotate">Sets the time interval for auto rotation</span>',control:"number",table:{type:{summary:"number"},defaultValue:{summary:_.msPerAutoRotate}}},resetScrollOnUpdateChildrens:{description:'<span id="resetScrollOnUpdateChildrens">Determines if the carousel should reset to the start position when child elements are updated.</span>',control:"boolean",table:{type:{summary:"boolean",detail:`
...
_________________________________________________________________________________________________
                                `},defaultValue:{summary:_.resetScrollOnUpdateChildrens}}},draggable:{description:'<span id="draggable">Enables dragging functionality</span>',control:"boolean",table:{type:{summary:"boolean"},defaultValue:{summary:_.draggable}}},touchThreshold:{description:'<span id="touchThreshold">Sets the touch threshold for dragging</span>',control:{type:"range",min:1,max:400},table:{type:{summary:"number",detail:`
